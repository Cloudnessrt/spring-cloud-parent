...
public class RedisAop {
    ...
    @Pointcut("@annotation( com.tomorrow.monitorbusi.Redis.RedisCacheAble)")// 定义注解类型的切点，只要方法上有该注解，都会匹配
    ...
    @Pointcut("@annotation( com.tomorrow.monitorbusi.Redis.RedisLockAnnotation)")// 定义注解类型的切点，只要方法上有该注解，都会匹配
